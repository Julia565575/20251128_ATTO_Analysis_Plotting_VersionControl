...
for analyt_name, group in df.groupby(analyte_col):
    ...
    # =====================================================
        ...
        # DataFrame updaten (hier keine quadratische Fitparameter)
        ...
        plt.figure(figsize=(6, 4))
        plt.scatter(x_time, faktor_values, color='green', alpha=0.7, label="Faktoren (berechnet)")
        plt.plot(x_fit_left_dt, y_fit_left, color='red', label="LinFaktor 1")
        plt.plot(x_fit_right_dt, y_fit_right, color='orange', label="LinFaktor 2")
        plt.axhline(1, color='gray', linestyle='--', label="Reference = 1.0")
