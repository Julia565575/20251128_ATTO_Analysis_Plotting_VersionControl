...
for analyt_name, group in df.groupby(analyte_col):
    ...
    # Dateiname & Pfad
    dateiname = f"{datumsteil}_{analyt_name}_nurCalibrierpunkte_linear.png"
...
for analyt_name, group in df.groupby(analyte_col):
    ...
    # Speichern
    dateiname = f"{datumsteil}_{analyt_name}_Korrekturfunktion_linear.png"
    pfad = os.path.join(ordnername, dateiname)
    plt.savefig(pfad, bbox_inches='tight')
    plt.show()
    plt.close()
...
for analyt_name, group in df.groupby(analyte_col):
    ...
    # Speichern
    dateiname = f"{datumsteil}_{analyt_name}_Proben_linear.png"
    pfad = os.path.join(ordnername, dateiname)
    plt.savefig(pfad, bbox_inches='tight')
    plt.show()
    plt.close()
...
for analyt_name, group in df.groupby(analyte_col):
    ...
    # Save
    dateiname = f"{datumsteil}_{analyt_name}_DailyPattern_linear.png"
    pfad = os.path.join(ordnername, dateiname)
    plt.savefig(pfad, bbox_inches='tight')
    plt.show()
    plt.close()
