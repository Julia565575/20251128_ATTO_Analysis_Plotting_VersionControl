...
for analyt_name, group in df.groupby(analyte_col):
    dC_Korrektur = group[group[datafile_col].str.contains('_dC_', na=False) & group[datafile_col].str.endswith(('_03.D', '_06.D', '_09.D', '_12.D'))]
    #dC_Korrektur = group[group[datafile_col].str.contains('_dC_', na=False)&group[datafile_col].str.endswith(('_03', '_06', '_09', '_12')]
    ...
    referenz_zeitpunkt_str = "2025-05-26 08:08"#################################################################################################################change#######################
